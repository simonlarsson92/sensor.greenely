...
**daily_produced_electricity (Optional)** | boolean | Creates a sensor showing daily produced electricity data. The state of this sensor is todays's total production so far. Default `false`.
...
**produced_electricity_days (Optional)** | number | How many days of produced electricity data you want. Default `10`.
